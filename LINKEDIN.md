...
1. Adicione **Experiência** usando o nome exato "Code Solutions" (o passo mais importante)
2. Coloque o site no **Destaques (Featured)**
3. Atualize o **About (Resumo)**
4. Avalie e vincule a página existente "Code Solutions" (ou crie alternativa se necessário)
5. Faça um post de lançamento

Isso é muito mais forte do que só adicionar o link no seu perfil pessoal ou no About.
...
**No formulário "Add experience" do LinkedIn preencha assim:**

- **Company**: Code Solutions (digite e selecione a página da empresa que você administra — a de code-solutions-it — para vincular automaticamente)
- **Title**: Backend Engineer
- **Location**: Canoas, Rio Grande do Sul, Brasil
- **Currently working here?**: Marque "Yes" (ou "Estou trabalhando atualmente nesta função")
- **Start date**: Escolha o mês/ano em que começou a operar via Code Solutions (ex: January 2023). Me fala a data que você quer usar que eu atualizo aqui.
- **End date**: Deixe em branco (porque está marcado como current)
- **Employment type**: Self-employed (melhor opção para PJ/consultoria independente. "Freelance" ou "Contract" também funcionam)
- **Description**: Cole o texto completo abaixo (foco em tecnologias e serviços que atendo atualmente via Code Solutions PJ; sem exemplos específicos de clientes passados como Sicredi/Panvel nesta descrição — o histórico completo fica em outras partes do perfil ou no site)
- **Skills**: Adicione várias relevantes (Java, Play Framework, Elasticsearch, Scala, Apache Kafka, Apache Flink, Akka, Legacy System Modernization, Event-Driven Architecture, AI Agents, Backend Development, etc.)
- **Media**: Opcional por enquanto. Você pode adicionar depois o link do site ou uma imagem do hero.jpg

**Location type** (se aparecer): Remote (projetos remotos para o Brasil e também para fora do Brasil)

### Descrição sugerida (copie e cole no campo Description):

Code Solutions é minha estrutura PJ para prestação de serviços de engenharia backend e automação com IA.
...
**English version (for the Experience description if using English interface or bilingual profile):**

Code Solutions is my PJ structure for backend engineering and AI automation services.
...
Based on over 20 years of experience with complex large-scale systems (accumulated in CLT positions, external consulting and now via PJ).
...
Através da **Code Solutions (PJ)** atuo como Backend Engineer com foco em manutenção e modernização de sistemas legados (Java, Play Framework, Elasticsearch, Scala/Akka e arquiteturas event-driven).
...
A expertise é fundamentada em mais de 20 anos de experiência em sistemas complexos de larga escala, acumulada em posições CLT, consultoria externa e agora via PJ.
...
The expertise is built on over 20 years of experience with complex large-scale systems, accumulated in CLT positions, external consulting, and now via PJ.
